@echo off
REM =======================================================
REM  Build Demo Script for the 3D Model Print Tracker Database
REM =======================================================
...
SET DEPLOY_SCRIPT=Deploy-Demo.sql
...
ECHO -- Creating application-specific utility procedures... >> %DEPLOY_SCRIPT%
REM Only include scripts that are part of the application.
REM Do NOT include dangerous developer-only scripts like ResetDatabase.sql.
type .\scripts\ResetDemoData.sql >> %DEPLOY_SCRIPT%
ECHO. >> %DEPLOY_SCRIPT%
ECHO GO >> %DEPLOY_SCRIPT%
