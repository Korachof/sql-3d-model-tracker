...
---
PRINT '--- TEST 1: Add a new printer ---';
...
---
PRINT '--- TEST 2: Try to add the same printer again (duplicate) ---';
...
---
PRINT '--- TEST 3: Add a second, different printer ---';
-- Expected: Return Status = 0, a new PrinterID is created.
EXEC @ReturnStatus = dbo.AddPrinter
...
---
PRINT '--- TEST 4: Validation Failure (NULL Brand) ---';
...
---
PRINT '--- FINAL VERIFICATION: View all printers ---';
